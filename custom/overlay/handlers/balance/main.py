...
def register_balance_handlers(dp: Dispatcher):
    ...
    from .sbp_manual import (
        start_sbp_payment,
        handle_sbp_bank_selection,
        handle_sbp_amount,
        handle_sbp_confirm,
        handle_sbp_approve,
    )

    dp.callback_query.register(start_sbp_payment, F.data == 'topup_manual')
    dp.callback_query.register(handle_sbp_bank_selection, F.data.startswith('sbp_bank_'))
    dp.callback_query.register(handle_sbp_confirm, F.data == 'sbp_confirm_pay')
    dp.callback_query.register(handle_sbp_approve, F.data.startswith('sbp_approve:'))
    dp.message.register(handle_sbp_amount, BalanceStates.waiting_for_sbp_amount)
